  ...
  return (
    <div className='shadow-md rounded-md p-4 mb-8'>
      <div className='flex gap-2 items-center mb-2 px-2 text-sm'>
        <img className='w-8 rounded-full' src={`${import.meta.env.VITE_API_SERVER}/files/${item.user.profile}`} alt="" />
        <a href="" className='font-semibold text-blue-700 dark:text-blue-300'>{item._id} {item.user.name}</a>
